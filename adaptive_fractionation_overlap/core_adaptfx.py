...
def adaptive_fractionation_core(fraction: int, volumes: np.ndarray, accumulated_dose: float, steepness_penalty: float, steepness_benefit: float, number_of_fractions: int = 5, min_dose: float = 6, max_dose: float = 10, mean_dose:float  = 8, dose_steps: float = 0.25, alpha: float = 1.072846744379587, beta:float = 0.7788684130749829, minimum_benefit = 0):
